...
export default function Countdown() {
  ...
  const TimeUnit = ({ value, label, index }) => (
    ...
    >
      <motion.div
        className="hud-frame p-4 md:p-6 min-w-20 md:min-w-24"
        animate={{ y: [0, -5, 0] }}
      ...
      <span 
        className="text-xs md:text-sm mt-2 font-semibold uppercase tracking-widest"
        style={{
  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-r from-cyan-500/5 via-transparent to-purple-500/5 relative overflow-hidden border-y border-cyan-500/30">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex justify-center gap-2 md:gap-6 flex-wrap items-center">
          <TimeUnit value={timeLeft.days} label="DAYS" index={0} />
          <motion.span 
            className="text-4xl md:text-5xl font-black self-center"
            style={{
              color: '#00ff88',
              textShadow: '0 0 10px rgba(0, 255, 136, 0.8)',
            }}
        ...
        >
          <motion.button
            className="neon-btn px-8 py-3 rounded-none"
            whileHover={{
