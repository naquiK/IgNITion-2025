...
export default function EventCard({ event, index }) {
  ...
  return (
    ...
    >
      <div 
        className="h-48 relative overflow-hidden border-b-2 border-cyan-500/50"
        style={{
      ...
      >
        <motion.div
          ...
          style={{
            background: 'conic-gradient(from 0deg, rgba(0, 255, 136, 0.6), rgba(0, 153, 255, 0.6), rgba(255, 0, 153, 0.4))',
          }}
        />
      ...
      <div className="p-6">
        ...
        <div className="space-y-2 mb-4 text-sm border-l-4 border-cyan-500/70 pl-4 py-2">
        ...
        <motion.button
          className="w-full py-3 border-2 rounded-none text-sm font-bold uppercase tracking-widest relative overflow-hidden group/btn"
          style={{
            color: '#00ff88',
      ...
      <motion.div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-cyan-500" 
        animate={{
          boxShadow: [
      ...
      />
      <motion.div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-cyan-500"
        animate={{
          boxShadow: [
